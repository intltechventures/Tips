...
# Tips for the Curl command line utility
...
### 2019
- https://daniel.haxx.se/blog/2019/06/24/openssl-engine-code-injection-in-curl/
  + "f you downloaded and installed a curl executable for Windows from the curl project before June 21st 2019, go get an updated one. Now."
  + https://curl.haxx.se/docs/CVE-2019-5443.html
    * Windows OpenSSL engine code injection
    * T"his flaw exists in the official curl-for-windows binaries built and hosted by the curl project (all versions up to and including 7.65.1_1). It does not exist in the curl executable shipped by Microsoft, bundled with Windows 10"
